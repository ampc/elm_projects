...
Elm.Main.make = function (_elm) {
   ...
   F2(function (click,count) {
      return count + 30.0;
   }),
   0,
   $Mouse.clicks);
   var heart = $Graphics$Collage.group(_L.fromArray([A2($Graphics$Collage.move,
                                                    {ctor: "_Tuple2"
                                                    ,_0: 0
                                                    ,_1: 0},
   ...
   var heartBeat = function (t) {
      ...
      700,
      700,
      _L.fromArray([$Graphics$Collage.scale($Basics.abs($Basics.sin(t / 100)))(heart)]));
   };
