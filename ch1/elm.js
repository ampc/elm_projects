...
Elm.Fibonacci.make = function (_elm) {
   ...
   var fibonacci = function (goal) {
      return function () {
         var fibonacci1 = F4(function (n,
         a,
         b,
         fibs) {
            return _U.cmp(n,
            goal) > -1 ? $List.reverse(fibs) : A4(fibonacci1,
            n + 1,
            a + b,
            a,
            A2($List._op["::"],a,fibs));
         });
         return A4(fibonacci1,
         0,
         1,
         0,
         _L.fromArray([]));
   ...
   var barColor = function (n) {
      return function () {
         var colors = _L.fromArray([$Color.red
                                   ...
                                   ,$Color.purple
                                   ,$Color.brown]);
         return $Maybe.withDefault($Color.black)($List.head(A2($List.drop,
         A2($Basics._op["%"],
         n,
         $List.length(colors)),
         colors)));
         ...
         {case "_Tuple2":
            return A2($Graphics$Element.flow,
              ...
              _L.fromArray([A3($Graphics$Collage.collage,
                           ...
                           20))]))
                           ,$Graphics$Element.leftAligned($Text.fromString("n"))]));}
         _U.badCase($moduleName,
